...
def minimalModel(t, var, con):
    [C3, C3b, C3bB_c, C3bB_o, C3bBb, FB, FH, C3bH, C3bBbH] = var
    [k, ks, d, FD, FI] = con
    
    dC3 = ks[1] - d[1]*C3 - k[1]*C3 - (k[2]*C3bBb*C3)/(k[3]+C3)
    dC3b = k[1]*C3 + (k[2]*C3bBb*C3)/(k[3]+C3) - k[4]*C3b*FB + k[5]*C3bB_c + k[6]*C3bBb - k[15]*C3b*FH + k[16]*C3bH + k[21]*C3bBbH
    dC3bB_c = k[4]*C3b*FB - k[5]*C3bB_c - k[9]*C3bB_c + k[10]*C3bB_o
    dC3bB_o = k[9]*C3bB_c - k[10]*C3bB_o - (k[7]*FD*C3bB_o)/(k[8] + C3bB_o)
    dC3bBb = (k[7]*FD*C3bB_o)/(k[8] + C3bB_o) - k[6]*C3bBb - k[25]*C3bBb*FH + k[16]*C3bBbH
    dFB = ks[2] - d[2]*FB - k[4]*C3b*FB + k[5]*C3bB_c
    dFH = ks[3] - d[3]*FH - k[15]*C3b*FH + k[16]*C3bH - k[25]*C3bBb*FH + k[16]*C3bBbH + (k[19]*C3bH*FI)/(k[20] + C3bH) + k[21]*C3bBbH
...
result = solve_ivp(minimalModel, t_span, var0, args=const, method='BDF')